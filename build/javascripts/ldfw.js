...
Game = (function() {
  function Game(wrapper) {
    ...
    this.context = this.wrapper.find("canvas").get(0).getContext("2d");
    this.running = false;
    this.setupStats();
  }
...
},{"../math/vector2.coffee":5}],3:[function(require,module,exports){
...
},{"./sprite.coffee":2}],4:[function(require,module,exports){
window.LDFW = {
...
},{"./game.coffee":1,"./graphics/sprite.coffee":2,"./graphics/textureatlas.coffee":3,"./math/vector2.coffee":5,"./screen.coffee":6,"./utilities/preloader.coffee":7}],5:[function(require,module,exports){
var Vector2;
...
},{"../vendor/async.js":8,"events":9}],8:[function(require,module,exports){
